...
public class PermissionNumberVerifier extends DSPInputVerifier implements KeyListener, MouseListener {

    public PermissionNumberVerifier(JDialog parentDialog, JComponent component) {
    ...
    public boolean verify(JComponent component) {
        ...
        boolean valid = field.getText().matches("[0-7][0-7][0-7]");
        if (valid) {
