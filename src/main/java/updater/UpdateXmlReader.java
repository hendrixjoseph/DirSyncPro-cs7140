...
public class UpdateXmlReader extends DefaultHandler {
	...
	public UpdateXmlReader(String url, boolean inB){
		...
		try{
			...
			if (!inBackground) DirSyncPro.displayError("Unable to generate XML parser to read the update script!");
		}catch (IOException e){
			if (!inBackground) DirSyncPro.displayError("Unable to contact the update server!");
		}catch (ParserConfigurationException e){
			if (!inBackground) DirSyncPro.displayError("Unable to parse the update XML!");
		}
	}
